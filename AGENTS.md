...
| [`go/css_test.go`](go/css_test.go), [`go/perf_test.go`](go/perf_test.go), [`go/parity_test.go`](go/parity_test.go), [`go/reworkcss_test.go`](go/reworkcss_test.go) | Go suite — the remaining in-language AST cases, the perf guard, the shared-fixture runner, and the external conformance corpus runner. |
