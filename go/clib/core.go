...
//
// libtabnascss is the css format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/css/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnascss"
	formatName      = "css"
	valueOut        = true
)
...
// newParser builds one engine with the css grammar installed
...
// parseWith answers whether src is in the css language — and,
